...
function Run() {
  ...
  this.clients.io = redis.createClient({
    host: this.opts.redis.host,
    port: this.opts.redis.port,
    password: this.opts.redis.password
  });
  ...
  this.clients.node = redis.createClient({
    host: this.opts.redis.host,
    port: this.opts.redis.port,
    password: this.opts.redis.password
  });
